                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="name" value="{{ old('name', $kelas->name) }}"
                                    ...
                                    <select name="jurusan_id" id="jurusan_id"
                                        ...
                                        @foreach ($jurusan as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $kelas->jurusan_id ? 'selected' : '' }}>({{ $item->kode }}) -
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="col-sm-10">
                                    <select name="guru_id" id="guru_id"
                                        ...
                                        @foreach ($guru as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $kelas->guru_id ? 'selected' : '' }}>
                                                {{ $item->user->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="kode" value="{{ old('kode', $kelas->kode) }}"
