@extends('layouts.app')
@section('title', 'Data Siswa Kelas 12')
@section('content')
        ...
        <div class="col-md-8">
                                    ...
                                    @if ($item->status_kelas == 0)
                                        <tr>
                                            <td>
                                                ...
                                                <input type="hidden" name="tingkat" value="12">
                                            </td>
                                            <td> {{ $item->name }} </td>
                                        </tr>
                                    @else
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <a style="text-decoration:none" href="{{ route('siswa12.mm') }}">
                ...
                <div class="col-sm-6 col-md-6">
                    <a style="text-decoration:none" href="{{ route('siswa12.pkm') }}">
                        <div class="card card-stats card-round">
                            <div class="card-body ">
                                <div class="row align-items-center">
                                    <div class="col-icon">
                ...
                <div class="col-sm-6 col-md-6">
                    <a style="text-decoration:none" href="{{ route('siswa12.tkj') }}">
                        <div class="card card-stats card-round">
                            <div class="card-body ">
                                <div class="row align-items-center">
                                    <div class="col-icon">
                ...
                <div class="col-sm-6 col-md-6">
                    <a style="text-decoration:none" href="{{ route('siswa12.tbsm') }}">
                        <div class="card card-stats card-round">
                            <div class="card-body ">
                                <div class="row align-items-center">
                                    <div class="col-icon">
