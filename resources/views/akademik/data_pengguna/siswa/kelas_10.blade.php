@extends('layouts.app')
@section('title', 'Data Siswa Kelas 10')
@section('content')
        ...
        <div class="col-md-8">
                                    ...
                                    @if ($item->status_kelas == 0)
                                        <tr>
                                            <td>
                                                ...
                                                <input type="hidden" name="tingkat" value="10">
                                            </td>
                                            <td> {{ $item->name }} </td>
                                        </tr>
                                    @else
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <a style="text-decoration:none" href="{{ route('siswa10.dkv') }}">
                ...
                <div class="col-sm-6 col-md-6">
                    <a style="text-decoration:none" href="{{ route('siswa10.lp') }}">
                        <div class="card card-stats card-round">
                            <div class="card-body ">
                                <div class="row align-items-center">
                                    <div class="col-icon">
                ...
                <div class="col-sm-6 col-md-6">
                    <a style="text-decoration:none" href="{{ route('siswa10.tkj') }}">
                        <div class="card card-stats card-round">
                            <div class="card-body ">
                                <div class="row align-items-center">
                                    <div class="col-icon">
                ...
                <div class="col-sm-6 col-md-6">
                    <a style="text-decoration:none" href="{{ route('siswa10.tsm') }}">
                        <div class="card card-stats card-round">
                            <div class="card-body ">
                                <div class="row align-items-center">
                                    <div class="col-icon">
