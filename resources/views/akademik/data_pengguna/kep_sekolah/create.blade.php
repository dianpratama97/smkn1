...
@section('content')
    ...
    <div class="card">
        ...
        <form action="{{ route('kepsek.store') }}" method="post"> @csrf
            <div class="col-md-6 ml-auto mr-auto">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-sm @error('no_telp') is-invalid @enderror" name="alamat" cols="10">{{ old('alamat') }}</textarea>
