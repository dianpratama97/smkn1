                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('guru_id') is-invalid @enderror" id="guru_id"
                                ...
                                @foreach ($guru as $gr)
                                    <option value="{{ $gr->id }}"
                                        {{ old('guru_id', $tugas->guru_id) == $gr->id ? 'selected' : '' }}>
                                        {{ $gr->user->name }}</option>
                                @endforeach
                            </select>
                            @error('id')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('mapel_id') is-invalid @enderror" id="mapel"
                                ...
                                @foreach ($mapel as $mp)
                                    <option value="{{ $mp->id }}"
                                        {{ old('mapel_id', $tugas->mapel_id) == $mp->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('kelas_id') is-invalid @enderror" id="kelas"
                                ...
                                @foreach ($kelas as $kls)
                                    <option value="{{ $kls->id }}"
                                        {{ old('kelas_id', $tugas->kelas_id) == $kls->id ? 'selected' : '' }}>
                                        {{ $kls->kode }}</option>
                                @endforeach
                            </select>
                            @error('kelas_id')
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('tingkat_kelas') is-invalid @enderror" id="kelas"
                                ...
                                <option value="">--pilih--</option>
                                <option value="10"
                                    {{ old('tingkat_kelas', $tugas->tingkat_kelas) == '10' ? 'selected' : '' }}>10</option>
                                <option value="11"
                                    {{ old('tingkat_kelas', $tugas->tingkat_kelas) == '11' ? 'selected' : '' }}>11</option>
                                <option value="12"
                                    {{ old('tingkat_kelas', $tugas->tingkat_kelas) == '12' ? 'selected' : '' }}>12</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="hari" id="hari" class="form-control @error('hari') is-invalid @enderror">
                                <option value="">--pilih--</option>
                                <option value="senin" {{ old('hari', $tugas->hari) == 'senin' ? 'selected' : '' }}>Senin
                                </option>
                                <option value="selasa" {{ old('hari', $tugas->hari) == 'selasa' ? 'selected' : '' }}>Selasa
                                </option>
                                <option value="rabu" {{ old('hari', $tugas->hari) == 'rabu' ? 'selected' : '' }}>Rabu
                                </option>
                                <option value="kamis" {{ old('hari', $tugas->hari) == 'kamis' ? 'selected' : '' }}>Kamis
                                </option>
                                <option value="jumat" {{ old('hari', $tugas->hari) == 'jumat' ? 'selected' : '' }}>Jumat
                                </option>
                                <option value="sabtu" {{ old('hari', $tugas->hari) == 'sabtu' ? 'selected' : '' }}>Sabtu
                                </option>
                            </select>
                            @error('hari')
                                <strong class='text-danger'>{{ $message }}</strong>
                            ...
                            <select name="jurusan" id="jurusan"
                                ...
                                @foreach ($jurusan as $jr)
                                    <option value="{{ $jr->kode }}"
                                        {{ old('jurusan', $tugas->jurusan) == $jr->kode ? 'selected' : '' }}>
                                        {{ $jr->kode }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control form-control-sm">
                                <option value="1" {{ old('status', $tugas->status) == 1 ? 'selected' : '' }}>AKTIF
                                </option>
                                <option value="2" {{ old('status', $tugas->status) == 2 ? 'selected' : '' }}>SELESAI
                                </option>
                                <option value="3" {{ old('status', $tugas->status) == 3 ? 'selected' : '' }}>TIDAK
                                    AKTIF</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="judul" id="judul" class="form-control form-control-sm @error('judul') is-invalid @enderror"
                                cols="5" rows="5">{{ old('judul', $tugas->judul) }}</textarea>
                            @error('judul')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="catatan" name="catatan" class="form-control @error('catatan') is-invalid @enderror" rows="40">{{ old('catatan', $tugas->catatan) }}</textarea>
                            @error('catatan')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
